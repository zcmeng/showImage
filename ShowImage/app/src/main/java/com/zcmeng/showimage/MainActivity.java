...
import jcc.example.com.browseimg.JBrowseImgActivity;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(jcc.example.com.browseimg.R.layout.activity_main);

        mIvTest = findViewById(jcc.example.com.browseimg.R.id.iv_test);
        mIvTest1 = findViewById(jcc.example.com.browseimg.R.id.iv_test1);
        mIvTest2 = findViewById(jcc.example.com.browseimg.R.id.iv_test2);
        mIvTest3 = findViewById(jcc.example.com.browseimg.R.id.iv_test3);
    ...
    public void onClick(View v) {
        int id = v.getId();
        if (id == jcc.example.com.browseimg.R.id.iv_test) {
            startBrowse(0);
        } else if (id == jcc.example.com.browseimg.R.id.iv_test1) {
            startBrowse(1);
        } else if (id == jcc.example.com.browseimg.R.id.iv_test2) {
            startBrowse(2);
        } else if (id == jcc.example.com.browseimg.R.id.iv_test3) {
            startBrowse(3);
        }
    }
}
